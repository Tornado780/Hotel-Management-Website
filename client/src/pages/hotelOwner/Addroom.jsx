...
const Addroom = () => {
  ...
  return (
    <form action="">
      <Title align='left' title="Add Room" font="outfit" subTitle="Add a new room to your hotel."/> 
      ...
      <div className="grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap">
        {Object.keys(images).map((key) => (
          <label htmlFor={`roomImage${key}`} key={key}>
            <img className="max-h-32 cursor-pointer opacity-80" src={images[key] ? URL.createObjectURL(images[key]) : assets.uploadArea } alt="" />
      ...
      <button className="bg-indigo-500 text-white px-8 py-2 rounded mt-8 cursor-pointer"> Add Room</button>
